...
$game = Illuminated::Game->init_test('Illuminated::Tile::GuardedSpace', [6, 6, 6, 6], [], ['S', 'S', 'quit']);
...
$game = Illuminated::Game->init_test('Illuminated::Tile::GuardedSpace', [1, ((4) x 9) , 6, 6, 6], [], ['S', 'S', 'quit']);
$game->run();
foreach my $f (@{$game->foes})
{
...
$game = Illuminated::Game->init_test('Illuminated::Tile::GuardedSpace', [6, 1, 1, 1, ((4) x 9)], [], ['S', 'S', 'quit']);
$game->run();
foreach my $f (@{$game->foes})
{
    is($f->aware, 1, $f->name . " is aware");
